...
router.post("/photozone", admin_controller_1.uploadPhotoZone);
router.patch("/photozone", admin_controller_1.modifyTagList);
router.post("/guideline", admin_controller_1.uploadGuideline);
router.patch("/guideline", admin_controller_1.modifyTagList);
