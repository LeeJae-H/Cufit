...
router.post('/upload', guideline_controller_1.uploadGuideline);
router.get("/main", guideline_controller_1.getGuidelineTop5);
router.get("/:id", guideline_controller_1.getGuidelineById);
router.get("/uid/:uid", guideline_controller_1.getGuidelineByUid);
