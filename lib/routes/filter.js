...
router.get("/main", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (var item of list) {
        ...
        const sortBy = item.b;
        const sort = item.s;
        const filters = yield filter_1.Filter.getListFromTagWithSort(tag, sortBy, sort);
        const data = {
            title: item.d,
            tag: tag,
            list: filters
...
router.get("/cid/:cid", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield filter_1.Filter.getListFromCreatorId(cid);
        res.status(200).json({
            result
        });
    }
...
router.get("/uid/:uid", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield filter_1.Filter.getListFromCreatorUid(uid);
        res.status(200).json({
            result
        });
    }
