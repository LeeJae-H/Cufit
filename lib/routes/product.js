...
router.get("/detail/:productId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const salingFilters = yield filter_1.Filter.getListFromCreatorUid(tUser.uid, "authorized");
        const salingGuidelines = yield guideline_1.Guideline.getListFromCreatorUid(tUser.uid, "authorized");
        user = tUser;
