...
GuidelineSchema.statics.getListFromCreatorUid = function (uid, auth) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (auth === "all") {
                ...
                const result = yield Guideline.find({ creatorUid: uid, authStatus: auth }).sort({ _id: -1 }).limit(50)
                    .populate('likedCount')
                    .populate('wishedCount')
                    .populate('usedCount')
                    .populate('creator');
...
GuidelineSchema.statics.getListFromTag = function (tag, auth) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = yield Guideline.find({ tags: { $elemMatch: { $regex: tag, $options: 'i' } }, authStatus: auth }).sort({ _id: -1 }).limit(50)
                .populate('likedCount')
                .populate('wishedCount')
                .populate('usedCount')
                .populate('creator');
...
GuidelineSchema.statics.getListFromTagWithSort = function (tag, sortBy, sort, auth) {
    return __awaiter(this, void 0, void 0, function* () {
